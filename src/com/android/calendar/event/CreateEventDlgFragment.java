 ...
 */
public class CreateEventDlgFragment extends DialogFragment implements TextWatcher {


    private static final String TAG = "CreateEventDlgFragment";
    ...
    public CreateEventDlgFragment(Time day) {
        setDay(day);
    }
