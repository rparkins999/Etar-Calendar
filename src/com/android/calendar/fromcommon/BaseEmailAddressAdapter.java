...
package com.android.calendar.fromcommon;
 ...
 * and/or contact name. It also searches registered {@see Directory}'s.
 */
public abstract class BaseEmailAddressAdapter extends CompositeCursorAdapter implements Filterable {
    ...
    /**
     * Model object for a {@see Directory} row. There is a partition in the
     * {@link CompositeCursorAdapter} for every directory (except
     * {@see Directory#LOCAL_INVISIBLE}.
     */
     ...
     * contact provider and the list of {@see Directory}'s.
     */
